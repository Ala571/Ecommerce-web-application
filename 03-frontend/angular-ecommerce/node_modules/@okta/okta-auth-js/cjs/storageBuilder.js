...
function storageBuilder(webstorage, storageName) {
  ...
  function getStorage() {
    ...
    try {
      ...
      throw new _AuthSdkError.default('Unable to parse storage string: ' + storageName);
    }
  }
  ...
  function setStorage(storage) {
    try {
      ...
      throw new _AuthSdkError.default('Unable to set storage: ' + storageName);
    }
  }
